...
(cl:defmethod cl:initialize-instance :after ((m <Coord2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Coord2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smelling_detection-msg:<Coord2D> is deprecated: use smelling_detection-msg:Coord2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Coord2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smelling_detection-msg:x-val is deprecated.  Use smelling_detection-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Coord2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smelling_detection-msg:y-val is deprecated.  Use smelling_detection-msg:y instead.")
  (y m))
